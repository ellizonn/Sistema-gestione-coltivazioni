        ...
        return new Promise((resolve, reject) => {
            ...
            this.db.get(sql, [id_proprieta], (err, rows) => {
                if (err) 
                    ...
                    resolve({error404: 'Nessun dispositivo_iot trovato per questa proprieta.'});
                else {
